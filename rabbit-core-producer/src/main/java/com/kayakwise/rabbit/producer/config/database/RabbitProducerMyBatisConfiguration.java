package com.kayakwise.rabbit.producer.config.database;
...
public class RabbitProducerMyBatisConfiguration {
	...
	public SqlSessionFactory rabbitProducerSqlSessionFactory(DataSource rabbitProducerDataSource) {
		...
		try {
			bean.setMapperLocations(resolver.getResources("classpath:com/kayakwise/rabbit/producer/mapping/*.xml"));
